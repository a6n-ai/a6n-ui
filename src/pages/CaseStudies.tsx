                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div className={`h-40 bg-gradient-to-br ${caseStudy.color} border-b border-border/30 flex items-center justify-center`}>
                                            ...
                                            <div className="p-5 flex flex-col flex-1 relative">
                                                ...
                                                <div className="mt-auto">
                                                    <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${caseStudy.tagColor}`}>
                            ...
                            <Card className="p-6 text-left border-border/50 bg-card/50">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">Showcase your use case in our library</p>
                                    </div>
                                </div>
                            </Card>
                            ...
                            <Card className="p-6 text-left border-border/50 bg-card/50">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">Inspire teams to unlock new possibilities</p>
                                    </div>
                                </div>
                            </Card>
                            ...
                            <Card className="p-6 text-left border-border/50 bg-card/50">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">Join our community of innovators</p>
                                    </div>
                                </div>
                            </Card>
                        </div>
