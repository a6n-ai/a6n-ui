...
import {ArrowRight, BarChart, Brain, Code, DollarSign, Headphones, MessageSquare, Settings} from "lucide-react";
                      ...
                      <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${useCase.tagColor}`}>
                        {useCase.department}
                                        ...
                                        <div className="flex items-center justify-between gap-3">
                                            ...
                                            <ArrowRight
                                                className="h-4 w-4 md:h-5 md:w-5 text-muted-foreground group-hover:text-primary transition-all duration-300 group-hover:translate-x-1 flex-shrink-0"/>
                                        </div>
                                    </div>
                                </Card>
                            </div>
