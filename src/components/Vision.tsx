      ...
      <div className="container-width">
        <div className="px-6 md:px-10">
          <div className="space-y-8">
            ...
            >
              From agency services to a self-serve platform, we begin as your AI
              partner and evolve to empower all businesses.
            </p>

            {/* Roadmap Timeline */}
            <div
              className={`flex flex-col md:flex-row items-start justify-start gap-4 md:gap-8 mt-12 ${
