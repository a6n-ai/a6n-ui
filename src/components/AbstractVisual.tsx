        ...
        >
            ...
            <defs>
                <linearGradient id="gradient1" x1="0%" y1="0%" x2="100%" y2="100%">
                    ...
                    <stop offset="100%" stopColor="#077FE8" stopOpacity="0.1"/>
                </linearGradient>
            ...
            <g filter="url(#blur)">
                ...
                {/* Small Circles */}
                <circle cx="800" cy="600" r="60" fill="#E0F2FE" fillOpacity="0.1"/>
                <circle cx="1200" cy="300" r="40" fill="#DBEAFE" fillOpacity="0.15"/>
                <circle cx="400" cy="550" r="80" fill="#077FE8" fillOpacity="0.08"/>
            ...
            <pattern id="dots" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
                <circle cx="2" cy="2" r="1" fill="#077FE8" fillOpacity="0.1"/>
            </pattern>
