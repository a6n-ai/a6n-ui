...
const HamburgerIcon = ({ className, ...props }: React.SVGAttributes<SVGElement>) => (
    ...
    >
        <path
            d="M4 12L20 12"
            className="origin-center -translate-y-[7px] transition-all duration-300 ease-&lsqb;cubic-bezier(.5,.85,.25,1.8)&rsqb group-aria-expanded:translate-x-0 group-aria-expanded:translate-y-0 group-aria-expanded:rotate-[315deg]"
        />
        <path
            d="M4 12H20"
        ...
        <path
            d="M4 12H20"
            className="origin-center translate-y-[7px] transition-all duration-300 ease-&lsqb;cubic-bezier(.5,.85,.25,1.8)&rsqb group-aria-expanded:translate-y-0 group-aria-expanded:rotate-[135deg]"
        />
    </svg>
);
// Types
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            >
                                ...
                                <span className="hidden font-bold text-xl sm:inline-block">a6n.io</span>
                            </Link>
                            {/* Navigation menu */}
                            {!isMobile && (
